...
# URL de inicio
START_URLS = ["https://www.argentina.gob.ar/economia/energia"]

# Palabras clave para filtrar las tablas
PALABRAS_CLAVE = [
    'energia', 'limpia', 'renovable', 'MW', 'capacidad', 'potencia', 'provincia', 'Centrales y plantas'
]

# Dominio Base
DOMINIO_BASE = 'argentina.gob.ar/economia/energia/'
...
EXCLUDE_PATHS_REGEX = r'(buscar|contacto|noticias|faq|ayuda|terminos|privacidad|resolucion|documentos-de-trabajo|historias|consultas|audiencias|acuerdo|concurso|audiencia)'
...
def main_crawler_scraper():
    ...
    urls_de_interes = []
    output_filename = "Objetivo7/urls_con_tablas.txt"
